...
char user[] = "equipeoaib123";            //nome do usuário do MySQL.
char password[] = "equipeoaib123";        //senha do usuário do MySQL.

char ssid_wifi[] = "LEXCOM MENEZES";  //nome da rede WiFi.
char senha_wifi[] = "28047810.";      //senha da rede WiFi.

char INSERT_DATA[] = "INSERT INTO  esp32_db.temperatura (ID_ESP, temperatura) VALUES (%d,%s)";
